...
FxWindow::FxWindow(SamplerTrackBoost* tb) :
	BWindow(BRect(0,200,180,430),"SampleWindow", B_FLOATING_WINDOW, B_ASYNCHRONOUS_CONTROLS|B_OUTLINE_RESIZE|B_NOT_ZOOMABLE|B_NOT_RESIZABLE|B_WILL_ACCEPT_FIRST_CLICK|B_AVOID_FOCUS)
	{
	booster=tb;
